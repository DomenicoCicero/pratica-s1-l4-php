...
$stmt = $pdo->prepare('SELECT * FROM users WHERE username LIKE ? LIMIT 5 OFFSET 5');
$stmt->execute([
    "%$search%"
])
...
<nav aria-label="Page navigation example text-center">
  <ul class="pagination justify-content-center">
    <li class="page-item"><a class="page-link" href="http://localhost/pratica-s1-l4-php/pag1.php">Previous</a></li>
    <li class="page-item"><a class="page-link" href="http://localhost/pratica-s1-l4-php/pag1.php">1</a></li>
    <li class="page-item"><a class="page-link bg-primary text-white" href="http://localhost/pratica-s1-l4-php/pag2.php">2</a></li>
    ...
    <li class="page-item"><a class="page-link" href="http://localhost/pratica-s1-l4-php/pag3.php">Next</a></li>
  </ul>
</nav>
