...
$stmt = $pdo->prepare('SELECT * FROM users WHERE username LIKE ? LIMIT 5 OFFSET 10');
$stmt->execute([
    "%$search%"
])
...
<nav aria-label="Page navigation example text-center">
  <ul class="pagination justify-content-center">
    <li class="page-item"><a class="page-link" href="http://localhost/pratica-s1-l4-php/pag2.php">Previous</a></li>
    ...
    <li class="page-item"><a class="page-link bg-primary text-white" href="http://localhost/pratica-s1-l4-php/pag3.php">3</a></li>
    <li class="page-item"><a class="page-link" href="http://localhost/pratica-s1-l4-php/pag4.php">4</a></li>
    <li class="page-item"><a class="page-link" href="http://localhost/pratica-s1-l4-php/pag4.php">Next</a></li>
  </ul>
</nav>
